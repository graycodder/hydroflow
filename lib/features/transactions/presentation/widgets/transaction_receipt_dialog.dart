...
import 'package:watermemo/features/transactions/presentation/utils/receipt_pdf_generator.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        'Legal Note: This receipt is generated by the WaterMemo management platform on behalf of $agencyName. WaterMemo is a software provider and is not responsible for water quality, delivery, or service related matters.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: Colors.grey[600],
                          fontSize: 10,
